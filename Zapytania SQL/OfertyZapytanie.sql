...
FROM CDN.OfertyDok
	LEFT OUTER JOIN CDN.OfertyKnt ON CDN.OfertyDok.OfD_OfDId = CDN.OfertyKnt.OfK_OfDId
	LEFT OUTER JOIN CDN.DefEtapy ON CDN.OfertyDok.OfD_StatusId = CDN.DefEtapy.DEt_DEtId
